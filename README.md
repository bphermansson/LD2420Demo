...
cd   /project/Esp32/LD2420Demo

Adjust in code, pins for the LD2420:

#define SENSOR_TX_PIN 9   // Pin 9 on Esp, RX on LD2420.
#define SENSOR_RX_PIN 10  // Pin 10 on Esp, OT1 on LD2420.
...
Adjust portnumber if necessary.

Done!

-- Old README from Sensors project: --
